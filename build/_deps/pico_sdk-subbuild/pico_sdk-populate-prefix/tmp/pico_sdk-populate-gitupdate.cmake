...
execute_process(
  COMMAND "/usr/bin/git" show-ref "1.4.0"
  WORKING_DIRECTORY "/home/vikrant/Dropbox/git/2022-hw-mini/build/_deps/pico_sdk-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1.4.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/1.4.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/vikrant/Dropbox/git/2022-hw-mini/build/_deps/pico_sdk-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/vikrant/Dropbox/git/2022-hw-mini/build/_deps/pico_sdk-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/bin/git" submodule update  --init lib/tinyusb
    WORKING_DIRECTORY "/home/vikrant/Dropbox/git/2022-hw-mini/build/_deps/pico_sdk-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
